...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-dc41g1q.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-dc41g1q.containers.anotherwebservice.com/
...
```
git clone git@github.com:FallingCave5354/container-dc41g1q.git
cd container-dc41g1q
```
...
```
docker attach container-dc41g1q
```
